...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/utils/cities.js":[function(require,module,exports) {
"use strict";
...
var _default = State;
exports.default = _default;
},{"./Subject":"src/lib/Subject.js"}],"src/lib/Observer.js":[function(require,module,exports) {
"use strict";
...
function (_Observer) {
  ...
  _createClass(List, [{
    ...
    value: function createMarkup(state) {
      return "<ul>\n    ".concat(state.cities.map(function (city) {
        return "<li class=\"alert alert-success\" >".concat(city.name, "</li>");
      }).join("\n"), "\n    </ul>");
    }
  }, {
    key: "render",
...
var _default = List;
exports.default = _default;
},{"../lib/Observer":"src/lib/Observer.js"}],"src/components/Form.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      var markup = this.createMarkup(this.state);
      var parent = document.getElementById(selector);
      parent.innerHTML = markup;
      this.bindEvents();
    ...
    value: function bindEvents() {
      ...
      cityInput.addEventListener("click", function (e) {
        var name = cityInput.children.name.value;
...
function (_Observer) {
  ...
  _createClass(Count, [{
    key: "createMarkup",
    value: function createMarkup(state) {
      return "<span>\n    cities count: ".concat(state.cities.length, "\n    </span>");
    }
  }, {
    key: "render",
    value: function render(state) {
...
var _default = Count;
exports.default = _default;
},{"../lib/Observer":"src/lib/Observer.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

require("./styles.css");

var _cities = _interopRequireDefault(require("./utils/cities"));
...
// Instantiate classes.
var AppState = new _State.default(); // application state - the subject

var namesList = new _List.default(); // Create a new user list. - the observer

var cityInput = new _Form.default(AppState); // Create a new city form.

var cityCount = new _Count.default(); // Create a new Count class.
// Hydrate state with initial cities.

AppState.update({
  cities: _cities.default
}); // Add the observers. These objects will re-render when state changes.

AppState.addObserver(namesList);
AppState.addObserver(cityCount); // On load, perform initial render..
...
},{"./styles.css":"src/styles.css","./utils/cities":"src/utils/cities.js","./lib/State":"src/lib/State.js","./components/List":"src/components/List.js","./components/Form":"src/components/Form.js","./components/Count":"src/components/Count.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
